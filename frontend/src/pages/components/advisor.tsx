  ...
  const year = today.getFullYear(); // Returns 1-31
   ...
   useEffect(() => {
    ...
    try {
      ...
      const response = await axios.get(`http://localhost:8081/suggest/${userId}`, {
        params:{
            month:month,
            year: year
        }
          ...
          <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="sm:flex sm:items-start">
              <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                <h3 className="text-base font-semibold text-gray-900" id="dialog-title">Financial Advice</h3>
                <div className="mt-2">
